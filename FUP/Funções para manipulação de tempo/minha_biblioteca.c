...
filme* alugar_filme(filme *v, cliente *vCliente, int *nfilme, int *ncliente) {
...
filme* devolver_filme(filme *v, int *nfilme, cliente *vCliente, int *ncliente) {
	
	int id, i, j, devolveu = 0, id_existe = 0;
	char cpf[13];
...
filme* relatorios_de_filmes(filme *v, int *nfilme) { // ERRRROO
